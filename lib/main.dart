  ...
  Future<void> _openOrShare(File file, {String? mimeType}) async {
    try {
      if (Platform.isWindows) {
        ...
        await Share.shareXFiles([XFile(file.path, mimeType: mimeType)], sharePositionOrigin: (() { final s = MediaQuery.of(context).size; return s.width > 0 && s.height > 0 ? Rect.fromLTWH(s.width / 2 - 50, s.height / 2 - 25, 100, 50) : const Rect.fromLTWH(100, 300, 200, 50); })());
      }
      if (mounted) {
