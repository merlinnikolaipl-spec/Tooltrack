  ...
  static const _dict = <AppLang, Map<String, String>>{
    ...
    'setRole': 'Назначить роль',
      ...
      'noGpsData': 'Нет GPS-данных',
                'locationDisclosureTitle': 'Использование геолокации',
                'locationDisclosureText': 'ToolKeeper использует данные о местоположении устройства, в том числе в фоновом режиме, чтобы фиксировать начало и конец смены и вести учёт рабочего времени на объекте, даже когда приложение свёрнуто. Разрешить доступ к геолокации?',
                'allow': 'Разрешить',
},
    AppLang.uk: {
      'appTitle': 'ToolKeeper',
